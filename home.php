            ...
            <div id="Home-carousel" class="carousel slide" data-bs-ride="carousel" data-interval="100">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="carousel-image1" src="images/UserHomeImages/HomeImage.jpg" alt="Model">
                    ...
                    <div class="carousel-item">
                        <img class="carousel-image2" src="images/UserHomeImages/Mens_Offer.jpg" alt="lady-profile">
                        <h2 class="carousel-text2"> <span>20%</span><br>OFF<br>on Men's Fashion. </h2>
                    </div>
                    <div class="carousel-item">
                        <img class="carousel-image3" src="images/UserHomeImages/New-arrivals.jpg" alt="lady-profile">
            ...
            <div class="swiper category-slider">
                ...
                <div class="swiper-wrapper">
                    ...
                    <a href="category.php?category=Men" class="swiper-slide slide">
                        <img src="images/UserHomeImages/mens-outfits.webp" alt="men.jpg">
                        <h3>Men</h3>
                    </a>

                    <a href="category.php?category=ladies" class="swiper-slide slide">
                        <img src="images/UserHomeImages/womens-outfits.webp" alt="women.jpg">
                        <h3>Women</h3>
                    </a>

                    <a href="category.php?category=Kids" class="swiper-slide slide">
                        <img src="images/UserHomeImages/kids-outfits.webp" alt="kids">
                        <h3>Kids</h3>
                    </a>

                    <a href="category.php?category=Shoes" class="swiper-slide slide">
                        <img src="images/UserHomeImages/shoes-outfit.webp" alt="shoes.jpg">
                        <h3>Shoes</h3>
                    </a>
